	...
	case "addBackpack": {
		...
		[(unitBackpack _unit), {
			_this addEventHandler ["ContainerOpened", {
				...
				private _civComment = selectRandom ["Sai fora da minha mochila","O que você está fazendo?","Me deixe em paz!","Saia!","O que você está jogando ai?"];
