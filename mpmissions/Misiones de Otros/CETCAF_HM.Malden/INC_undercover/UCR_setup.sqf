...
_civilianVests = ["V_LegStrapBag_olive_F","V_LegStrapBag_black_F","V_LegStrapBag_coyote_F"];
...
_civilianUniforms = ["U_C_E_LooterJacket_01_F","U_I_L_Uniform_01_tshirt_olive_F","U_I_L_Uniform_01_tshirt_sport_F","U_I_L_Uniform_01_tshirt_skull_F","U_I_C_Soldier_Bandit_5_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F","U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_4_F","U_OrestesBody","U_BG_Guerilla3_1","U_O_R_Gorka_01_black_F","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_I_C_Soldier_Bandit_4_F","U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_5_F","U_I_C_Soldier_Bandit_3_F"];
...
_incogFactions = ["OPF_F","OPF_T_F","IND_F","IND_G_F","IND_L_F","OPF_G_F"]; //Array of enemy factions whose items and vehicles will allow the player to impersonate the enemy
