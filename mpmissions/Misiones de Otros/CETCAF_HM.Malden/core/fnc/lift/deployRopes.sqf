...
ropeCreate [_heli, "slingload0", 30, []];
...
btc_lift_action = player addAction ["<t color=""#ED2744"">" + (localize "STR_BTC_HAM_ACTION_VEHINIT_HOOK") + "</t>",{[] call btc_fnc_lift_hook}, [], 20, true, false, "", "[] call btc_fnc_lift_check"]; //"<t color=""#ED2744"">" + ("Hook") + "</t>"
