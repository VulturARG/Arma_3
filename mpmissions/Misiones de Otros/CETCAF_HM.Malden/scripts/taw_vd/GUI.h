...
class _RscControlsGroupNoScrollbars : _RscControlsGroup {
...
class TAW_VDMenu {
	...
	class controlsBackground {
		class TitleBackground : _RscText {
		...
		class Title : RscTitle {
			...
			idc = -1;
			text = "Configurações de visão (SCRIPT)";
			x = .3;
			y = .2;
			w = .8;
			h = (1 / 25);
		...
		class TerrainBackground : TitleBackground {
			text = "Configurações de grama";
			shadow = 0;
			y = .46;
		};

		class ObjectBackground : TitleBackground {
			text = "Configurações de objeto";
			y = .55;
		};
	...
	class controls {
		...
		class VD_onFoot_slider : RscXSliderH {
			...
			toolTip = "Distâcia de visão enquanto estiver a pé";
			x = .42;
			y = .30 - (1 / 25);
		...
		class VD_inCar_slider : VD_onFoot_slider {
			idc = GROUND_SLIDER;
			toolTip = "Distâcia de visão enquanto estiver em veículo térreo";
		...
		class VD_inAir_slider : VD_onFoot_slider {
			idc = AIR_SLIDER;
			toolTip = "Distâcia de visão enquanto estiver em veículo aéreo";
		...
		class VD_Object_slider : VD_onFoot_slider {
			idc = OBJECT_SLIDER;
			toolTip = "Distância de renderização dos objetos";
		...
		class VD_Drone_slider:VD_onFoot_slider {
			idc = DRONE_SLIDER;
			toolTip = "Distâcia de visão enquanto openrando um UAV/UGV";
		...
		class ObjectSyncCheckbox : RscCheckbox
		{
			idc = 2931;
			x = .32; y = .6;
			tooltip = "Sincronizar a renderização dos objetos com a renderização da visão";
		...
		class ObjectSynctext : _RscText {
			idc = -1;
			text = "Sincronizar com distância";
			x = .345; y = .596;
			w = .35; h = .04;
		};
		
		class Manager:_RscControlsGroup {
			idc = MANAGER_GROUP;
			
			x = -0.21; y = .2;
			w = .5; h = 3;
			class Controls {
				class SaveLoadGroup:_RscControlsGroupNoScrollbars {
					idc = SAVELOAD_GROUP;
					...
					class Controls {
						class MyTitleBackground:_RscText {
							colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
							idc = -1;
							x = 0;
							y = 0;
