...
["<t size='3' color='#222222'>Campaña Auxilium",0,0.4,1,2,0.0] spawn bis_fnc_dynamictext; //Si existe, si no, comentar con // y no se ejecutara el comando.
...
["<t size='0.9' color='#FFFFFF'>Auxilium - Lavandina",0,0.4,2,2,0.0] spawn bis_fnc_dynamictext;

any= ["Auxilium - Lavandina",
"Altis",
 "0717 hs"
