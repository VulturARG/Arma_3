...
Respawn_truck_typename = "acfaa_unimog_hospital";	// This is the mobile respawn (and medical) truck. 																						Default is "B_Truck_01_medical_F".
huron_typename = "ACFAA_EA_CH47F_M134";											// This is Spartan 01, a multipurpose mobile respawn as a helicopter. 																	Default is "B_Heli_Transport_03_unarmed_F".
...
light_vehicles = [
	...
	["acfaa_unimog_flatbed",120,0,60],								//UNIMOG carga
...
air_vehicles = [
	...
	["B_acfaa_Light_01_stripped_F",200,0,100],									//MH-6M Little Bird
	["B_acfaa_Light_01_armed_F",200,200,100],									//AH-6M Little Bird Artillado
	["ACFAA_ARG_UH1H_M60",225,0,125],									//UH-1H (M60)
	["ACFAA_ARG_UH1H_AR",225,200,125],										//UH-1H (Cohetero)
	["ACFAA_ARG_UH1H_MED",225,200,125],										//UH-1H (Medico)
	["acfaa_heli_BELL212_m240",225,200,125],										//Bell 212
	["RHS_AH1Z",500,500,200],											//AH-1Z (Multi-Rol)
	["RHS_AH64D",750,750,250],											//AH-64D (Multi-Rol)
	["RHS_UH60M_MEV2_d",300,0,150],										//UH-60M MEV2
	["ACFAA_EA_CH47F_M134_M240",275,80,175],										//CH-47 Chinook (Armado)
