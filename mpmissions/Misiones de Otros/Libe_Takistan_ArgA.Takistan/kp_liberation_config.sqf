...
GRLIB_save_key = "KP_LIBERATION_VS1_ARGA" + (toUpper worldName) + "_SAVEGAME";
...
KP_liberation_production_interval = 50				/ GRLIB_resources_multiplier;								// Time in minutes until a production process is finished, when resources multiplier is set to 1.
