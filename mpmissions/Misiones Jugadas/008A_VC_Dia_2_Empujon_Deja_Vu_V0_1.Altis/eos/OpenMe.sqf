...
if (_jugadores <= 10) then {
  null = [["M_Panagia_EOS_2","M_Panagia_EOS_3"],[8,0,100],[0,0,100],[0,0],[0],[0],[0,0],[5,1,600,EAST,FALSE]] call EOS_Spawn;
  null = [["M_Panagia_EOS"],[0,0,100],[7,1,100],[0,0],[0],[0],[0,0],[5,1,300,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 10 && _jugadores <= 15) then {
  null = [["M_Panagia_EOS_2","M_Panagia_EOS_3"],[10,0,100],[0,0,100],[0,0],[0],[0],[0,0],[5,1,600,EAST,FALSE]] call EOS_Spawn;
  null = [["M_Panagia_EOS"],[0,0,100],[7,2,100],[0,0],[0],[0],[0,0],[5,1,300,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 15 && _jugadores <= 20) then {
  null = [["M_Panagia_EOS_2","M_Panagia_EOS_3"],[15,0,100],[0,0,100],[0,0],[0],[0],[0,0],[5,1,600,EAST,FALSE]] call EOS_Spawn;
  null = [["M_Panagia_EOS"],[0,0,100],[7,3,100],[0,0],[0],[0],[0,0],[5,1,300,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 20 && _jugadores <= 25) then {
  null = [["M_Panagia_EOS_2","M_Panagia_EOS_3"],[6,1,100],[0,0,100],[0,0],[0],[0],[0,0],[5,1,600,EAST,FALSE]] call EOS_Spawn;
  null = [["M_Panagia_EOS"],[0,0,100],[9,3,100],[0,0],[0],[0],[0,0],[5,1,300,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 25) then {
  null = [["M_Panagia_EOS_2","M_Panagia_EOS_3"],[8,1,100],[0,0,100],[0,0],[0],[0],[0,0],[5,1,600,EAST,FALSE]] call EOS_Spawn;
  null = [["M_Panagia_EOS"],[0,0,100],[11,3,100],[0,0],[0],[0],[0,0],[5,1,300,EAST,FALSE]] call EOS_Spawn;
};
