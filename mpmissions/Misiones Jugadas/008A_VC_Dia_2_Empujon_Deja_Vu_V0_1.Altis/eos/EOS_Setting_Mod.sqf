...
if (_jugadores <= 10) then {
  null = [[_marker],[6,2],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 10 && _jugadores <= 15) then {
  null = [[_marker],[8,2],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 15 && _jugadores <= 20) then {
  null = [[_marker],[7,3],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 20 && _jugadores <= 25) then {
  null = [[_marker],[9,3],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 25) then {
  null = [[_marker],[7,4],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
