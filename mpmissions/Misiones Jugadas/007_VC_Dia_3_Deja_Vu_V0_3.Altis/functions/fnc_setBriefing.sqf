...
params["_recursos", "_enemigos", "_objetivos", "_situacion", "_situacionGeneral", "_info", "_editores", "_importante", "_instrucciones"];
...
player createDiaryRecord["Diary", ["IMPORTANTE", ([_importante, true] call MANDI_fnc_makeInfo)]];
...
player createDiaryRecord["Diary", ["Situaci"+toString[243]+"n hist"+toString[243]+"rica", ([_situacionGeneral, false] call MANDI_fnc_makeInfo)]];
