...
if (_jugadores <= 10) then {
  null = [["M_Charkia_EOS"],[20,0,100],[6,2,100],[0,0],[0],[0],[0,0],[5,1,1500,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 10 && _jugadores <= 15) then {
  null = [["M_Charkia_EOS"],[25,0,100],[9,2,100],[0,0],[0],[0],[0,0],[5,1,1500,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 15 && _jugadores <= 20) then {
  null = [["M_Charkia_EOS"],[30,0,100],[12,2,100],[0,0],[0],[0],[0,0],[5,1,1500,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 20 && _jugadores <= 25) then {
  null = [["M_Charkia_EOS"],[15,1,100],[7,3,100],[0,0],[0],[0],[0,0],[5,1,1500,EAST,FALSE]] call EOS_Spawn;
};
if (_jugadores > 25) then {
  null = [["M_Charkia_EOS"],[15,1,100],[9,3,100],[0,0],[0],[0],[0,0],[5,1,1500,EAST,FALSE]] call EOS_Spawn;
};
