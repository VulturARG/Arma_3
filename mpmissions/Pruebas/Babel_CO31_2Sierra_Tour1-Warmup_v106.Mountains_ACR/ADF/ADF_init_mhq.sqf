...
// Reporting
if (ADF_debug || ADF_extRpt || time < 180) then {diag_log "ADF RPT: Init - executing: ADF_init_mhq.sqf"};
...
if (ADF_debug) then {diag_log format ["ADF Debug: ADF_init_mhq.sqf - Diag time to execute function: %1",diag_tickTime - _dt]};
