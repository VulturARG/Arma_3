...
Script: Mission init - Preset for communities/clans/campaigns
Author: Whiztler
Script version: 2.03

File: ADF_init_presets.sqf
**********************************************************************************
This script lets you customize call signs and radio freqs for groups.
The call signs and radio freqs are displayed in the roster, cTAB, MicroDAGR, etc.
You Only need to configure the call sign for the leader of the group. All other
team members will get the correct call sign automatically.
*********************************************************************************/

// Reporting
if (ADF_debug || ADF_extRpt || time < 180) then {diag_log "ADF RPT: Init - executing: ADF_init_presets.sqf"};

///// Nopryl Community Preset
ADF_preset_NOPRYL = [

	//---------- INFANTRY PLATOON & COMPANY COMMAND ----------
	
	//	Group (don't edit)	Call Sign, 		TFAR LR	TFAR SW
...
ADF_preset_WP = [
	...
	[],[],[],[],											// 32-35
	[	"gGM1",			"TRAINER",		35,		350]	// GM-1						36 > V202
	 												
// DO NOT EDIT BELOW
];	

///// Two Sierra campaign preset
ADF_preset_2S = [
	//	Group (don't edit)	Call Sign, 		TFAR LR	TFAR SW	
	[],													//							0
