...
File: ADF_init_mb.sqf
*********************************************************************************
ABOUT
The mission balancer is automatically loaded on mission start. It requires
maxPlayers in 'mission\ADF_mission_information.sqf' to be defined. The
...
Spawn probability set by the mission balancer:
...
/* 
// Reporting
if (ADF_debug || ADF_extRpt || time < 180) then {diag_log "ADF RPT: Init - executing:  ADF_init_mb.sqf"};
