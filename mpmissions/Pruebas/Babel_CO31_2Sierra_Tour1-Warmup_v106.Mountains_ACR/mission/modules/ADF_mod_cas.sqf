...
Copy and the module (this file) to your scripts folder: "scripts\ADF_mod_cas.sqf";

Fill out the required and optional details below.

Execute in your mission script: execVM "scripts\ADF_mod_cas.sqf";
Or Execute via a trigger: 0 = [] execVM "scripts\ADF_mod_cas.sqf";
...
Step 2.	Fill out below configuration
Step 3.	Add the following line to your script to execute the CAS request module:
		execVM "scripts\modules\ADF_mod_cas.sqf";
*/
...
///// DO NOT EDIT BELOW
if (isNil ADF_CAS_requester) exitWith {};
