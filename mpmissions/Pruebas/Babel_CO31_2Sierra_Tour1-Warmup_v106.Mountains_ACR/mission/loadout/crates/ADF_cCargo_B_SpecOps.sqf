...
null = [this] execVM "mission\loadout\crates\ADF_cCargo_B_SpecOps.sqf";
...
private _wpn = 2; 	// Regular Weapons
private _spw = 1; 	// Special Purpose Weapons
private _lau = 1;		// Launchers
private _mag = 50;	// Magazines
private _gre = 10;	// Grenades
private _dem = 10;	// Demo/Explosives
private _mis = 2;		// Missiles/Rockets
private _itm = 3;		// Items
private _uni = 5;		// Uniform/Vest/Backpack/etc
