...
private _MANDI_ARTILLERY_DISTANCIA = 225;
private _MANDI_ARTILLERY_DISPERSION = 75;
private _MANDI_SECURE_AREA = 100;

// Artilleria pesada
private _MANDI_ARTILLERY_DISCOVER_DISTANCE = 4000;
private _MANDI_ARILLERY_RELOAD_TIME = 180;
// Mortero
private _MANDI_ARTILLERY_MORTER_DISCOVER_DISTANCE = 2000;
private _MANDI_ARILLERY_MORTER_RELOAD_TIME = 180;

private _MANDI_ROUNDS_PER_WAVE = 3; // Rondas por orden
