...
/*
_PreciseSize = [10,12,14];									// Randomly select number of mortars per "Precise" rotation.														Array of numbers (Mortars)
_PreciseReloadTime = 30;									// The time it takes for the mortar to prepare for another strike after performing a Precise strike.				Number (Seconds)
