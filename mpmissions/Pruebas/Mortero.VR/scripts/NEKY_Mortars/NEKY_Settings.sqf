...
_Avoid = false;//True;												// Avoid firing near friendlies, if friendlies are within "inaccuracy" area, it will hold fire and rescan.			Boolean
...
_PreciseSize = [6,8,10];									// Randomly select number of mortars per "Precise" rotation.														Array of numbers (Mortars)
