...
_firstshot = [cam3, cam2, bandera, 20, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _firstshot};

_secondshot = [cam2, cam2, bandera, 10, 1, 1, false, 0, 0, 0,TRUE] execVM "AL_intro\camera_work.sqf";
