...
if (_jugadores <= 10) then {
  ...
  //Oleadas impares
  null = [_marker,[3,1,1000],[4,1,1000],[0,1500],[0,1,1500],[4,1,1500,600],[0,3,200,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[1200,_waves,600,FALSE,FALSE],_angle] call Bastion_Spawn;
  //Oleadas pares
  null = [_marker,[3,1,1000],[0,3,1000],[0,1500],[4,1,1500],[0,0,1500,600],[0,3,200,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[1500,_waves,600,FALSE,FALSE],_angle] call Bastion_Spawn;
  // Última ola
...
if (_jugadores > 25 && _jugadores <= 30) then {
  //Asalto inicial
  null = [_marker,[0,2,1000],[0,3,1000],[0,1500],[0,1,1500],[0,0,1500,600],[7,3,300,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[60,1,600,FALSE,FALSE],_angle] call Bastion_Spawn;
  //Oleadas impares
  null = [_marker,[4,3,1000],[3,3,1000],[0,1500],[0,1,1500],[4,3,1500,600],[0,3,300,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[240,_waves,180,FALSE,FALSE],_angle] call Bastion_Spawn;
  //Oleadas pares
  null = [_marker,[4,3,1000],[0,3,1000],[3,1500],[4,3,1500],[0,0,1500,600],[0,3,300,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[420,_waves,180,FALSE,FALSE],_angle] call Bastion_Spawn;
  // Última ola
  null = [_marker,[0,2,1000],[7,2,1000],[5,1500],[0,1,1500],[5,4,1500,600],[0,3,300,5000],[6,1,_EOS_FACCION,FALSE,FALSE,true],[960,1,600,FALSE,FALSE],_angle] call Bastion_Spawn;
  // Apaches
  null = [_marker,[0,1,1000],[0,2,1000],[0,1500],[4,0,3000],[0,4,1500,600],[0,3,300,5000],[1,1,WEST,FALSE,FALSE,true],[1080,1,600,FALSE,FALSE],_angle] call Bastion_Spawn;
};
