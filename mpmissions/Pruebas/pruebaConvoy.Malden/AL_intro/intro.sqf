...
/*_firstshot = [cam_1, cam_2, artillero, 10, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _firstshot};
// * /

_secondshot = [cam_3, cam_3, artillero, 35, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _secondshot};
// */
_thirdshot = [cam_4, cam_4, cam_1, 20, 1, 2, true, -1.8, -6, 1,TRUE] execVM "AL_intro\camera_work.sqf";
