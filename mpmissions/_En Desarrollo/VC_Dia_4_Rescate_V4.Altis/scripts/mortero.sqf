params["_morter","_playerGroup","_tipeAttack","_density","_isAuto","_minimunDistance","_maximunDistance"];
//Mortar2
...
null = [_morter, east, _tipeAttack, _density, [_position, 80],_minimunDistance,_maximunDistance,20] execVM "scripts\NEKY_Mortars\NEKY_Mortars.sqf";
