...
//SPAWN LIGHT VEHICLES
	...
	_cGroup setGroupId [format ["%1 LV %2",_mkr,_counter]]; //LV Light vehicles
...
//SPAWN ARMOURED VEHICLES
	...
	if (isnil "_dGrp") then {_dGrp=[];};
		...
		_dGroup setGroupId [format ["%1 AV %2",_mkr,_counter]]; //AV Armoured vehicles
...
//SPAWN STATIC PLACEMENTS
	for "_counter" from 1 to _eGrps do {
		...
		_eGroup setGroupId [format ["%1 SP %2",_mkr,_counter]]; //AV Static Placements
