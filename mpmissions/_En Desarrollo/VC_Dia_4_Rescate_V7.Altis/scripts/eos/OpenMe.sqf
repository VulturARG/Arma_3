...
null = [["patrullas_H"],[0,2,100],[10,1,100],[0,0,0],[0,0],[0],[0,0,00],[5,1,200,_EOS_FACCION,false]] call EOS_Spawn;
...
null = [[_marker],[0,2,100],[10,2,100],[0,0,0],[0,0],[0],[0,0,00],[5,1,500,_EOS_FACCION,false]] call EOS_Spawn;
